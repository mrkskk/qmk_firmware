...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    [QWERTY] = LAYOUT(
// ,------------------------------------------.                            ,----------------------------+------+--------.
    ____, KC_Q, KC_W,  KC_E,  KC_R,  KC_T,                                KC_Y, KC_U,  KC_I,   KC_O,    KC_P,     DK_AA,    
// |--------+-----+------+------+------+------|                            |------+------+------+-------+------+--------|
...
// `---------------------+------+------+------+------+------||------+------+------+------+------+-----------------------'
                         UNTAB, KC_LGUI, TT_NR, NVSPC, SP_LEAD,  KC_BSPC, NVENT, OS_SYM, A_ESC, ____   
//                       `----------------------------------'`----------------------------------'
    ),
...
//                       `----------------------------------'`----------------------------------'  
    ...
    [NAV] = LAYOUT(
// ,------------------------------------------.                            ,----------------------------+------+--------.
    ____, ____, ____,  ____,  PRV_TAB,  PGUP,                               C_HOME,  PRVW,  OP,    NXTW,   ____, ____,    
// |--------+-----+------+------+------+------|                            |------+------+------+-------+------+--------|
