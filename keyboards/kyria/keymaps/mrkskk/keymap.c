...
// |--------+-----+------+------+------+------+------+------.,------+------+------+------+------+-------+------+--------|
    OSM_T_SFT, KC_Z, KC_X,  KC_C,  KC_D, KC_V,  FIND,  ____,  S_S, KC_TAB,    KC_K,  KC_H,  KC_COMM, KC_DOT, MINUS,  QUOT,    
// `---------------------+------+------+------+------+------||------+------+------+------+------+-----------------------'
                         UNTAB, SWAP1, TT_NR, NVSPC, TD(SPLEAD),  CBSPC, NVENT, SYESC, KC_LALT, ____   
//                       `----------------------------------'`----------------------------------'
    ),
...
// |--------+-----+------+------+------+------|                            |------+------+------+-------+------+--------|
    KC_F22,   AT,   QUOT,  LPRN,  RPRN,  HASH,                                  ASTR, TILD,  ACUT, GRV,   PIPE,   ____,       
// |--------+-----+------+------+------+------+------+------.,------+------+------+------+------+-------+------+--------|
...
// |--------+-----+------+------+------+------+------+------.,------+------+------+------+------+-------+------+--------|
    ____,    ____, CUT,   COPY,  PASTE,  ____,  FIND,  ____, ____, ____,  ____,  S_PRVW, ____, S_NXTW, ____,   ____,    
// `---------------------+------ +------+------+------+------||------+------+------+------+------+-----------------------'
...
// |--------+-----+------+------+------+------+------+------.,------+------+------+------+------+-------+------+--------|
    CAPS ,  ____, ____, COLEM,   ____,  ____,  ____,  ____,     ____,  ____, KC_F1, KC_F2, KC_F3, KC_F10, ____,   ____,    
// `---------------------+------+------+------+------+------||------+------+------+------+------+-----------------------'
