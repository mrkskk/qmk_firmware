...
// `---------------------+------+------+------+------+------||------+------+------+------+------+-----------------------'
                         UNTAB, KC_LGUI, TT_NR, NVSPC, TD(SPLEAD),  CBSPC, NVENT, OS_SYM, A_ESC, ____   
//                       `----------------------------------'`----------------------------------'
    ),
...
//                       `----------------------------------'`----------------------------------'
    ...
    [NUMPAD] = LAYOUT(
// ,------------------------------------------.                            ,----------------------------+------+--------.
    ____  ,  EXLM, DQUO,  LCB,   RCB,   PERC,                               SLSH,  KC_7,  KC_8,  KC_9,   MINUS, ____,       
// |--------+-----+------+------+------+------|                            |------+------+------+-------+------+--------|
    ____ ,   AT  , TILD,  LPRN,  RPRN,  HASH,                               ASTR,  KC_4,  KC_5,  KC_6,   PLUS,  ____,          
// |--------+-----+------+------+------+------+------+------.,------+------+------+------+------+-------+------+--------|
    ____ ,   LABK, RABK,  LBRC,  RBRC,  QUES,  ____,  ____,   ____,  ____,  KC_0, KC_1,  KC_2,  KC_3,    KC_DOT, KC_COMM,      
// `---------------------+------+------+------+------+------||------+------+------+------+------+-----------------------'
